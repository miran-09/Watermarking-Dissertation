...
def main(args):
    ...
    # random wm pattern
    # opt_wm = get_watermarking_pattern(pipe, args, device) # watermark latentc  dtype = torch.complex32ï¼ˆhalfï¼‰
    ...
    for steps in [35]:  # injection steps
        ...
        for i in tqdm(range(args.start, args.end)):
            ...
            # orig_image_no_w.save(f'generated_imgs/clean_new/ori-lg7.5-{i}-test.jpg')
            ...
            orig_image_w.save(f'generated_imgs/robin5-30-pixel-lessabs-500c-2kn/g7.5-{i}.jpg')
            ...
            for attack in ['none', 'rotation', 'jpeg', 'cropping', 'blurring', 'noise', 'color_jitter']:
                ...
                # distortion
                orig_image_no_w_auged, orig_image_w_auged = image_distortion(orig_image_no_w, orig_image_w, seed, attack, jpeg_ratio=args.jpeg_ratio or 25, crop_scale=args.crop_scale or 0.75, crop_ratio=args.crop_ratio or 0.75, gaussian_blur_r=args.gaussian_blur_r or 4, rotation_angle=args.rotation_angle, noise_std=args.noise_std, color_jitter_brightness=args.color_jitter_brightness,)
